...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/school-announcements/school-announcements.module').then(
        (m) => m.SchoolAnnouncementsPageModule
      ),
  },
  {
    path: 'class-announcements',
    loadChildren: () =>
      import('./pages/class-announcements/class-announcements.module').then(
        (m) => m.ClassAnnouncementsPageModule
      ),
  },
  {
    path: 'documents',
  ...
  },
  {
    path: 'fundraisers',
    loadChildren: () =>
      import('./pages/fundraisers/fundraisers.module').then(
